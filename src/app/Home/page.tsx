...
export default function Hom() {
	...
	if (user?.isvoted) {
		...
		return (
			<div className="h-screen flex flex-col flex-wrap justify-center align-center">
				<div className="flex justify-center items-center gap-5">
					<Image
						...
						src={"/penusimg.png"}
					/>
					<h1 className="text-5xl"> E-voting Penus</h1>
				</div>
				<h1 className="py-6 text-center flex-auto text-2xl sphone:text-5xl">
